...
const TrailingTabExplained = React.memo(() => {
      ...
      <Drawer open={open} onOpenChange={setOpen} repositionInputs={false}>
        <DrawerContent className="w-full bg-[#232329] max-w-[768px] max-h-[80vh] mx-auto">
          ...
          <DrawerDescription className="flex flex-col px-4 gap-[12px]">
            <Text text={t('orderForm.trailingTab.tooltipText')} fontWeight="light" color="#FFFFFFCC" fontSize={14} />
          </DrawerDescription>
...
TrailingTabExplained.displayName = 'TrailingTabExplained'

export default TrailingTabExplained
