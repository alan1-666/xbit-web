...
interface EntrustedHistoryFilterProps {
  filter: OrdersListFilter
  setFilter: (filter: OrdersListFilter) => void
  symbolList: ISymbolList[]
}

const EntrustedHistoryFilter = ({ filter, setFilter, symbolList }: EntrustedHistoryFilterProps) => {
...
export default EntrustedHistoryFilter
