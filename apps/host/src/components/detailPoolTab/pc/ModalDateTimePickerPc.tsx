    ...
    <>
      <Button size="xs" className="rounded-full bg-transparent p-0" onClick={handleOnOpenModal}>
        <img
          ...
          className={cn(isDesktop ? 'w-[14px] h-[14px]' : 'w-[11px] h-[11px]')}
          alt="icon filter"
        />
      </Button>
...
ModalDateTimePickerPc.displayName = 'ModalDateTimePickerPc'

export default memo(ModalDateTimePickerPc)
