...
const FilterPoolTransactionTypePc = React.memo(({
  ...
  return (
    <>
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="w-full bg-[#232329] max-w-[768px] max-h-[80vh] mx-auto">
          <DialogHeader>
          ...
          <DialogFooter className="pb-6 overflow-auto">
            <div className="mb-6">
...
FilterPoolTransactionTypePc.displayName = 'FilterPoolTransactionTypePc'

export default FilterPoolTransactionTypePc
