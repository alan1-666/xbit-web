...
/**
 * Hook for prediction event path (e.g. GlassLiquidNav).
 * Default: BTC crypto live 15m. Stores full event object.
 * No fake slug fallback - uses prediction home when no event available.
 */
export const usePredictionEventPath = () => {
