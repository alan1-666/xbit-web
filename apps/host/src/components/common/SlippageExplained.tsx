...
const SlippageExplained = React.memo(() => {
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogContent className="w-full bg-[#232329] max-w-[768px] max-h-[80vh] mx-auto p-3">
            ...
            <DialogDescription className="flex flex-col gap-[12px] mt-3">
              <Text text={t('tradeSettings.slippageTooltip')} fontWeight="light" color="#FFFFFFCC" fontSize={14} />
            </DialogDescription>
...
SlippageExplained.displayName = 'TPSLExplained'

export default SlippageExplained
