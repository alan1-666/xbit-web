            ...
            <DialogHeader>
              <DialogTitle className="mt-1.5">
                <div className="text-[calc(1rem*(22/16))] leading-[1] app-font-regular text-left">
                  {t('tradeSettings.gasFee')}
                </div>
              </DialogTitle>
            </DialogHeader>

            <DialogDescription className="flex flex-col gap-[12px] mt-3">
              <Text text={t('tradeSettings.gasFeeTooltip')} fontWeight="light" color="#FFFFFFCC" fontSize={14} />
            </DialogDescription>
...
export default GasFeeExplainend
