...
// TODO: check if overlayClassName is needed
    ...
    <DrawerPortal>
      <DrawerOverlay className="">
        <DrawerPrimitive.Content
          ref={ref}
          className={cn(
            'fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto flex-col rounded-t-[10px] border bg-background focus-visible:shadow-[none] pb-2',
            className,
          )}
          {...props}
        >
