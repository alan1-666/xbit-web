...
>(({ className, icon, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        'w-full flex items-center py-4 text-sm font-medium transition-all cursor-pointer text-left [&[data-state=open]>img]:rotate-180 [&[data-state=open]>svg]:rotate-180',
        className,
      )}
      {...props}
    >
      ...
      {icon ? (
        ...
        <img
          src="/images/icons/ic-down-new.svg"
