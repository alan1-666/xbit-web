...
import CurrentOrderCard from '../futuresDetails/trade/CurrentOrderList/CurrentOrderCard'
import { xOpenOrders } from '../futuresDetails/trade/types'

const mockOrders: xOpenOrders[] = [
  {
    coin: 'BTC',
    side: 'B',
    limitPx: '68000',
    ...
    <div>
      ...
      <div className="mt-1 flex flex-col gap-2">
        {mockOrders.map((order, index) => (
          <CurrentOrderCard key={index} orderInfo={order} />
        ))}
      </div>
    </div>
  )
