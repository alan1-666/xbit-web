...
import InfoRow from '../futuresDetails/drawerOrder/InfoRow'
import StatsCard from '../orderBook/StatsCard'
...
const BuyNowDrawerInVaultDetail = () => {
    ...
    <div>
      <Drawer open={open} onOpenChange={setOpen}>
        <DrawerTrigger asChild>
          <Button variant={'gradient'} className={cn('w-[175px] rounded-[50px] text-[#141414] h-[calc(1rem*(44/16))]')}>
            立即买入
          </Button>
        </DrawerTrigger>
...
export default BuyNowDrawerInVaultDetail
