...
export const PhantomWalletIcon =
...
export class PhantomWalletAdapter extends BaseMessageSignerWalletAdapter {
  ...
  async connect(): Promise<void> {
    try {
      ...
      if (!wallet || wallet?.isOkxWallet || wallet?.isOKExWallet) {
        throw new WalletNotReadyError('wallet_not_installed')
      }

      if (this._isMobileDevice() && wallet) {
      ...
      if (this.readyState !== WalletReadyState.Installed) throw new WalletNotReadyError('wallet_not_installed')
