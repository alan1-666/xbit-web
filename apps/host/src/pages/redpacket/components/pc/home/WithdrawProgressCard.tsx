...
const WithdrawProgressCard: React.FC<WithdrawProgressCardProps> = ({
  ...
  const dotPercent = Math.min( percent > 97 ? 97 : 100, Math.max(0.8, percent))
  ...
  return (
    <div className="h-[285px] aspect-[305/142] relative bg-[url('/images/redpacket/pc-bg-2.png')] bg-cover bg-center w-full  p-6 bg-gradient-to-b from-zinc-950 to-zinc-950/0 rounded-[20px] shadow-[inset_0px_11px_30px_0px_rgba(255,42,106,0.16)] outline-1 outline-offset-[-1px] outline-white/20 inline-flex flex-col justify-start items-start gap-8">
        ...
        <div className="self-stretch pt-12 flex flex-col justify-start items-center gap-px relative">
          <div className="self-stretch flex flex-col justify-start items-start gap-3">
            ...
            <div
              ...
              style={{ left: `${clampedPercent}%`, transform: 'translateX(-53%)' }}
            >
      ...
      <div className="text-center bg-white/10 rounded-[20px] shadow-[inset_0px_-1px_4px_0px_rgba(255,255,255,0.25),inset_2px_2px_4px_0px_rgba(255,255,255,0.25)] backdrop-blur-3px flex items-center justify-center px-5 py-2 w-full cursor-pointer" onClick={hanleWithdrawClick}>
