...
const GoogleResetVerifyQR: React.FC = () => {
        ...
        <div className="space-y-4">
          <div className="flex flex-col min-h-screen bg-gradient-to-b from-black via-gray-900 to-black text-white px-6 py-10">
            ...
            <div className="space-y-6 mb-8">
              ...
              <p className="text-sm leading-relaxed">{t('google.auth.introduction')}</p>

              <div className="space-y-2">
                <p className="text-sm">{t('google.auth.qrcode')}</p>
                <div className="flex justify-center">
                  <XQRCode value="https://google.com" />
                </div>
              </div>

              <div className="space-y-2">
                <p className="text-sm">{t('google.auth.decode')}</p>
                <div className="bg-gray-800 rounded-md p-4 text-center">
                  <p className="font-mono">X4V3S7IGUG7LP4NE</p>
                </div>
              </div>
            </div>
...
export default GoogleResetVerifyQR
