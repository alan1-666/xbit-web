...
const GoogleReset: FC<Props> = (props) => {
  ...
  return (
    <div className="flex flex-col text-white min-h-[calc(100vh_-_100px)]">
      <HeaderWithBack title={t('google.auth.reset.title')} onBack={handleBack} className="bg-transparent p-2.5" />
      <div className="px-2.5 flex-1 flex flex-col">
        <div className="main-content flex-1">
          ...
          <div className="flex flex-col items-center justify-center mt-4">
            <h1 className="text-xl text-center font-medium my-6">{t('google.auth.reset.confirmMsg')}</h1>
            <div className="p-4 border bg-[rgba(236,236,237,0.08)] rounded-lg">
              <p>
                {t('google.auth.reset.ensureMsg1')}
                <span className="text-red-500 mx-1">{t('google.auth.reset.ensureMsg2')}</span>
                {t('google.auth.reset.ensureMsg3')}
              </p>
            </div>
          </div>
        </div>
