...
const DialogDataOverview = ({ open, setOpen, currentLevel }: { open: boolean; setOpen: (value: boolean) => void, currentLevel: number }) => {
      ...
      >
        <div className="w-full">
          <div className="flex items-center justify-between py-3 border-b">
            ...
            <div className={cn('text-lg font-normal text-left flex-1 pl-4')}>{t('nodeAgent.commissionExplanation')}</div>
        ...
        <div className="px-4">
          <CommissionTable  currentLevel={currentLevel}/>
          <CommissionExplanation currentLevel={currentLevel} />  
        </div>
      </DialogContent>
    </Dialog>
  )
