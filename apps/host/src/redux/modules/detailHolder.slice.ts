...
export interface DetailHolderState {
  data: any[]
...
const initialState: DetailHolderState = {
  data: [],
  filterAddress: '',
...
const detailHolderSlice = createSlice({
  name: 'followedHolder',
  initialState,
  reducers: {
...
export const {
  ...
  reset
} = detailHolderSlice.actions

export default detailHolderSlice.reducer